...
public class Main {
    ...
    public static void main(String[] args) throws IOException {
        ...
        testNet.addConv(new int[] {5, 5}, 64);
        testNet.addReLU();

        testNet.addConv(new int[] {5, 5}, 128);
        testNet.addReLU();
        ...
        //Perform 12 epochs, decreasing learning rate to eventually focus on more subtle features in the dataset.
        for(int i = 0; i < 12; i++) {
            testTrain.epoch();
