...
public class Mat {
     ...
     */
    public static double[][] mm_mult(double[][] m1, double[][] m2) {
     ...
     */
    public static double[][] mm_add(double[][] m1, double[][] m2) {
     ...
     */
    public static double[][] v_zeros(int size) {
     ...
     */
    public static double[][] v_exp(double[][] v) {
     ...
     */
    public static double[][] v_scale(double[][] v, double scale) {
     ...
     * @return
     */
    public static double[][] m_scale(double[][] mat, double scale) {
     ...
     */
    public static double[][] m_transpose(double[][] mat) {
    ...
    /**
     * pretty prints a doubleing point vector with the specified number of significant figures.
     * @param v the input vector.
    ...
    /**
     * pretty prints a doubleing point matrix with the specified number of significant figures.
     * @param mat the input matrix.
     * @param decimal the number of significant figures applied element-wise.     
     */
    public static void m_print(double[][] mat, int decimal) {
        for (int i = 0; i < mat.length; i++) {
     ...
     */
    public static double[][] m_random(int h, int w) {
     ...
     * @return a 2D array of shape [h] X [w]
     */
    public static double[][] m_zeros(int h, int w) {
        double[][] result = new double[h][w];
        for (int i = 0; i < h; i++) {
            for (int j = 0; j < w; j++) {
                result[i][j] = (double) Math.random();
     ...
     */
    public static double[][] v_random(int w) {
     ...
     */
    public static double m_max(double[][] mat) {
        double max = mat[0][0];
        for (int i = 0; i < mat.length; i++) {
            for (int j = 0; j < mat[0].length; j++) {
